...
* Description: Y~X (Brain_weight~Body_Weight) linear model-How much of Brain g variation is explained by Body g
* Results: Body g is a good predictor of Brain g (90% predictive aptness using untransformed data)
* The model is 92% predictive using transformed data (a 2.2% improvement) (GOOD)-Good from a machine learning perspective;
...
%y_predict(x=2000); *Issue here is you ll need a calculator to calculate from the easy visual on the plot;
